                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Quantity',
                              labelStyle: const TextStyle(color: const Color(0xFF00BBF9)),
                              ...
                              focusedBorder: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(8),
                                borderSide: const BorderSide(color: const Color(0xFF00BBF9), width: 2),
                              ),
                ...
                boxShadow: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(color: const Color(0xFF00BBF9)),
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(8),
                        borderSide: const BorderSide(color: const Color(0xFF00BBF9)),
                      ),
                      ...
                      suffixText: '€',
                      prefixIcon: const Icon(Icons.euro, color: const Color(0xFF00BBF9)),
                      filled: true,
