...
class AppTheme {
  // Color Palette
  static const Color primaryColor = Color(0xFF00BBF9); // Primary Orange
  ...
  static const Color lightOrange = Color(0xFFE0F2FE); // Soft Light Blue Accent
  static const Color lightBlue =
      Color(0xFFE0F2FE); // Staff Menu Soft Light Blue
  static const Color darkBlue = Color(0xFF0284C7); // UI Dark Blue Accent
  static const Color success = Color(0xFF22C55E); // Green - keep
  static const Color successBackground =
      Color(0xFFDCFCE7); // Light Green - keep
  ...
  static const Color dividerColor =
      Color(0xFFF5F5F5); // Very Light Grey Divider
